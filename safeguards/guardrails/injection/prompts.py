# Inspired from the paper https://arxiv.org/abs/2402.00898
...
| 13  | Instruction Manipulation | Prompt leaking                   | Asking the chatbot to de- scribe the instructions writ- ten in the initial prompt that for example control what it can or cannot do. Indirect Prompt Injections.                                     |
